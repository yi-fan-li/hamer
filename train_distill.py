"""Training script for backbone distillation: ViT-B student from ViT-H teacher.

Usage:
    python train_distill.py \\
        exp_name=distill_vitb \\
        experiment=hamer_distill \\
...
from hamer.models.distilled_hamer import DistilledHAMER
...
def train(cfg: DictConfig) -> Tuple[dict, dict]:
    ...
    model = DistilledHAMER(cfg, init_renderer=False)
